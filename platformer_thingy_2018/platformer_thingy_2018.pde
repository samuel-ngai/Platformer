//"Damn this is a good project" - Some Random Game Company
//Samuel Ngai
...
void contactStarted(FContact contact) {
  ...
  if((contact.getBody1().getName() == "player_body" && contact.getBody2().getName() == "teleport_box")||
     (contact.getBody2().getName() == "player_body" && contact.getBody1().getName() == "teleport_box")) {
   ...
   if((contact.getBody1().getName() == "player_body" && contact.getBody2().getName() == "platform_box")||
     (contact.getBody2().getName() == "player_body" && contact.getBody1().getName() == "platform_box")) {
    //Put contact stuff here
    //if(jump == 1) {
    //  jump = 0;
    //}
   ...
   //  // }
   //  }
   if((contact.getBody1().getName() == "lava" && contact.getBody2().getName() == "water")||
     (contact.getBody2().getName() == "lava" && contact.getBody1().getName() == "water")) {
    //Put contact stuff here
    //if(jump == 1) {
    //  jump = 0;
    //}
    FBody lavaBody;
     ...
     //lavaBody.setPosition(lavaBody.getX(), lavaBody.getY());
      
    //if(dist(contact.getBody1().getX(),contact.getBody1().getY(),contact.getBody2().getX(),contact.getBody2().getY()) < 16) {
    //  l.setFillColor(rock);
    //  //b.setStatic(true);
    ...
    if((contact.getBody1().getName() == "player_body" && contact.getBody2().getName() == "lava")||
     (contact.getBody2().getName() == "player_body" && contact.getBody1().getName() == "lava")) {
    //Put contact stuff here
    //if(jump == 1) {
    //  jump = 0;
    //}
